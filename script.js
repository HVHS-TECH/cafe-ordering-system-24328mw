...
function openOrder(){
    ...
    NAME_FORM_OUTPUT.innerHTML += "<form id=nameForm onsubmit='return false'><label for=moneyField>$</label><input id=nameField type=number required><input type=submit onclick=getMoneyFormInput()></form>";
